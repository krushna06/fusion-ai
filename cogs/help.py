...
class Help(Cog_Extension):
    ...
    async def help(self, interaction: discord.Interaction):
        ...
        if allowed_channel_id and int(allowed_channel_id) != interaction.channel_id:
            ...
            return
        embed=discord.Embed(description="[krushna06/fusion-ai](https://github.com/krushna06/fusion-ai)\n***COMMANDS -***")
        embed.add_field(name="/cookies setting", value="Can upload own cookies.", inline=False)
        embed.add_field(name="/fusionai", value="Chat with Fusion AI.", inline=False)
